...
@section('content')
    ...
    <section class="user-dashboard">
        <div class="dashboard-outer">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('dashboard.beasiswa.store') }}" method="POST" class="default-form"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-12 col-md-12">
                                                ...
                                                <input type="text" name="NamaBeasiswa" placeholder="Nama Beasiswa"
                                                    value="{{ old('NamaBeasiswa') }}">
                                            </div>

                                            <!-- About Beasiswa -->
                                            <div class="form-group col-lg-12 col-md-12">
                                                <label>Deskripsi Beasiswa</label>
                                                <textarea name="Deskripsi" placeholder="Deskripsi Beasiswa">{{ old('Deskripsi') }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group col-lg-6 col-md-12">
                                                ...
                                                <input type="text" name="Pembiayaan" placeholder="Pembiayaan"
                                                    id="Pembiayaan" value="{{ old('Pembiayaan') }}">
                                            </div>
                                            ...
                                            <div class="form-group col-lg-6 col-md-12">
                                                ...
                                                <input type="number" name="JumlahPenerima" placeholder="Jumlah Penerima"
                                                    value="{{ old('JumlahPenerima') }}">
                                            </div>

                                            <!-- Input -->
                                            <div class="form-group col-lg-12 col-md-12">
                                                <label>Persyaratan</label>
                                                <textarea name="Persyaratan" placeholder="Persyaratan">{{ old('Persyaratan') }}</textarea>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-6 col-md-12">
                                                ...
                                                <select name="TipeBeasiswa" id="TipeBeasiswa">
                                                    <option value="Kampus"
                                                        {{ old('TipeBeasiswa') == 'Kampus' ? 'selected' : '' }}>Kampus
                                                    </option>
                                                    <option value="Non-Kampus"
                                                        {{ old('TipeBeasiswa') == 'Non-Kampus' ? 'selected' : '' }}>
                                                        Non-Kampus
                                                    </option>
                                                </select>
                                            </div>
                                                ...
                                                <select class="chosen-search-select" name="KampusID">
                                                    @foreach ($kampus as $item)
                                                        <option value="{{ $item->KampusID }}"
                                                            {{ old('KampusID') == $item->KampusID ? 'selected' : '' }}>
                                                ...
                                                <select class="chosen-search-select" name="PerusahaanID">
                                                    @foreach ($perusahaan as $item)
                                                        <option value="{{ $item->PerusahaanID }}"
                                                            {{ old('PerusahaanID') == $item->PerusahaanID ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group col-lg-6 col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <select data-placeholder="Choose a category..." class="chosen-select"
                                                        multiple tabindex="4" name="jenjang[]">
                                                        @foreach ($jenjang as $item)
                                                            <option value="{{ $item->JenjangID }}"
                                                                {{ in_array($item->JenjangID, old('jenjang', [])) ? 'selected' : '' }}>
                                                    ...
                                                    <select data-placeholder="Choose a category..." class="chosen-select"
                                                        ...
                                                        @foreach ($jurusan as $item)
                                                            <option value="{{ $item->JurusanID }}"
                                                                {{ in_array($item->JurusanID, old('jurusan', [])) ? 'selected' : '' }}>
